    ...
    class << self
      def configuracion_tipos
        [
          ...
          { id: 12, nombre: :ticket_no_fiscal,     descripcion: 'RECIBO DÉBITO',               codigo_afip: nil,  nombre_print: 'RECIBO DÉBITO',                       letra: 'X', multiplicador_saldo:  1, tiene_iva: false, adicionar_iva: false, mostrar_iva: false, recibo: false },
          { id: 13, nombre: :devolucion_no_fiscal, descripcion: 'RECIBO CRÉDITO',              codigo_afip: nil,  nombre_print: 'RECIBO CRÉDITO',                      letra: 'X', multiplicador_saldo: -1, tiene_iva: false, adicionar_iva: false, mostrar_iva: false, recibo: false },
        ]
      end
